...
-- Insert into Brand
INSERT INTO brand (name, is_deleted) VALUES
('Rolex', 0),
('Omega', 0),
('Casio', 0),
('Seiko', 0),
...
-- Insert into Product
INSERT INTO product (name, description, image_url, actual_price, sell_price, type, stock, brand_id, is_active, visible) VALUES
...
INSERT INTO supplier (name, address, phone, email, is_deleted) VALUES
('Watch Supplier Ltd.', '789 Maple St', '1122334455', 'supplier@example.com', 0);

-- Insert into Purchase
INSERT INTO purchase (product_id, supplier_id, price, quantity, total_price) VALUES
(1, 1, 8000, 5, 40000);