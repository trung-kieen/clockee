...
public class SendEmailServiceImpl implements SendEmailService {
  ...
  private void sendWelcomeEmail(User user, VerificationCode verificationCode) {
    ...
    String verificationLink = applicationProperties.getBaseUrl()
        + contextPath
  ...
  @Override
  public void sendOrderTrackingEmail(OrderStatus orderStatus, OrderEmailContext orderContext, String userEmail) {
