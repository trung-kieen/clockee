...
public class MapperUtil {
   ...
   */
  public static <S, D> PageResponse<D> mapPageResponse(Page<S> sourcePage, Class<D> destinationType) {

    var targetList = sourcePage.getContent().stream()
  ...
  public static <S, D> PageResponse<D> mapPageResponse(Page<S> sourcePage, Function<S, D> converter ) {

    List<D> targetList = sourcePage.getContent().stream()
