...
export const mockDetailOrderItems: Order[] = [
  ...
  },
  {
    order_id: 2,
    items: [
      { order_item_id: 2, product_id: 2, quantity: 2},
    ],
  },
  {
    order_id: 3,
  ...
  },
  {
    order_id: 4,
    items: [
      { order_item_id: 4, product_id: 4, quantity: 1},
    ],
  },
  {
    order_id: 5,
  ...
  },
  {
    order_id: 6,
    items: [
      { order_item_id: 6, product_id: 6, quantity: 4},
    ],
  },
  {
    order_id: 7,
    items: [
      { order_item_id: 7, product_id: 7, quantity: 1},
    ],
  },
  {
    order_id: 8,
    items: [
      { order_item_id: 8, product_id: 8, quantity: 2},
    ],
  },
  {
    order_id: 9,
    items: [
      { order_item_id: 9, product_id: 9, quantity: 3},
    ],
  },
  {
    order_id: 10,
    items: [
      { order_item_id: 10, product_id: 10, quantity: 1},
    ],
  },
];
