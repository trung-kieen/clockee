...
const products: Product[] = [
  {
    ...
    "description": "Nam - Quartz (Pin) - Mặt Số 45 mm x 42.1 mm, Giờ Thế Giới, chống nước 10ATM",
    "price": "1.506.000 đ",
    "sku": "AE-1000WHD-1AVDF",
    "stock": 7749,
    "images": ["/product1.png", "/watch2.png", "/watch3.png", "/watch4.png", "/watch5.png"]
  },
  {
    "id": 2,
  ...
  },
  {
    ...
    "description": "Nam - Quartz (Pin) - Đồng hồ dã ngoại, cảm biến nhiệt độ, độ cao",
    "price": "4.800.000 đ",
    "sku": "PRG-240-1DR",
    "stock": 750,
  ...
  return (
    <div className="container mx-auto flex flex-col md:flex-row items-start gap-10 p-10 justify-center">
      ...
      <div className="flex flex-col items-center">
        <img src={selectedImage || ""} alt={product.title} className="w-96 rounded-lg shadow-md" />
      ...
      <div className="flex flex-col max-w-lg">
        ...
        <div className="mt-4">
          <p className="text-gray-500">Mã Số Sản Phẩm: <b>{product.sku}</b></p>
