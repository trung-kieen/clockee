              ...
              {/* Tiêu đề */}
                <div className="flex  items-center bg-White rounded-md h-[80px]">
                  ...
                  <div className="flex justify-center w-[300px]">
                    <h2 className="text-xl font-bold text-black inte">Đặt lại mật khẩu</h2>
                  </div>
                </div>
              {/* Form Đăng ký */}
                <div className="px-10 ">
                  ...
                  />
                  {!isValid && <p className="text-red-500 text-sm pt-3">Email không hợp lệ</p>}
                  <button
                    className={`w-full bg-yellow-400 text-white p-3 rounded mt-5 font-semibold shadow-md ${
                              isValidEmail(email) ? "bg-yellow-400 hover:opacity-75" : "bg-yellow-230 cursor-not-allowed "}`}
                              disabled={!email.trim()}
                  >
                    Tiếp theo
                  </button>
